...
urlpatterns = [
    ...
    path(
        "merchants_percentage/", views.merchants_percentage, name="merchants_percentage"
    ),
    ...
    path(
        "transactiondominance/", views.transactiondominance, name="transactiondominance"
    ),
